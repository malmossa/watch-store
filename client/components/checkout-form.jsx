  ...
  render() {
    ...
    return (
      <div className="container mt-4">
        ...
        <div>
          <h6 className="pb-4 pt-2 text-muted">{`Order Total: $${dollars}.${cents}`}</h6>
        </div>
        <div className="row">
          <form id="checkoutForm" onSubmit={this.handleSubmit} onReset={this.handleReset} className="col-12">
            ...
            <div>
              <input value={this.state.name} onChange={this.handleChange} name="name" type="text" className="border rounded input-group mb-3"></input>
            </div>
            <div>
              <label>Credit Card</label>
            </div>
            <div>
              <input value={this.state.creditCard} onChange={this.handleChange} name="creditCard" type="text" className="border rounded input-group mb-3"></input>
            </div>
            <div>
              <label>Shipping Address</label>
            </div>
            <div>
              <textarea value={this.state.shippingAddress} onChange={this.handleChange} name="shippingAddress" className="shipping-address border rounded input-group mb-3"></textarea>
            </div>
